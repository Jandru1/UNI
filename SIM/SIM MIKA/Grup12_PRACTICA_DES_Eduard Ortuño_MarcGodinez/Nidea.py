...
class Resources2:
    def __init__(self, env, qqt_barbers2):
        self.barber = simpy.PriorityResource(env, capacity=qqt_barbers2)



class Resources3:
    def __init__(self, env, qqt_barbers3):
        self.barber = simpy.PriorityResource(env, capacity=qqt_barbers3)
...
class Model:
    ...
    def run(self):
        ...
        self.env.process(self.arribada_clients())
