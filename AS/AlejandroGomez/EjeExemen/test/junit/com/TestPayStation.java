...
public class TestPayStation {
  ...
  @Before
  public void setUp() {
    ps = new PayStationImpl(new StubStrategy());
  }
  ...
  */
  ...
  @Test 
  public void TestStubImplementation() throws NoEsPotCalcularImport {
	  assertEquals("Should do nothing and display potència", 50, ps.consultarImporte(50));
  }
